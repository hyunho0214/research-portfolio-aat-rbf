"""데이터 전처리 탭 – RawDataExtractorApp 리팩터링"""
...
"""
    ...
    def __init__(self, parent: ttk.Frame, on_export_callback: Callable[[str], None] | None = None):
        self.parent = parent
        self.on_export_callback = on_export_callback

        self.selected_files: list[str] = []
        self.available_columns: list[str] = []
        self.analyzed_rows: list[dict] = []
        ...
        self.column_list: list[tuple[str, tk.BooleanVar]] = []
    ...
    def export_raw_data(self):
        ...
        if self.on_export_callback:
            self.on_export_callback(out_path)
